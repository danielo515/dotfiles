...
__kickstart__LspConfig_LspConfig_Fields_.doY = function()
	local _ = ___TableWrapper_TableWrapper_Impl_.check(
		_hx_o({
			__fields__ = { doX = true, test = true, nest = true },
			doX = 99,
			test = true,
			nest = _hx_o({
				__fields__ = { a = true },
	...
	__kickstart__LspConfig_LspConfig_Fields_.testMethod(
		{ doX = 99, nest = { a = { renest = 99, b = { c = { meganest = 88 } } } }, test = true }
	)
end
