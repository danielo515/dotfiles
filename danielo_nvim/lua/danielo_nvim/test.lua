...
___TestMacros_TestMacros_Fields_.lotOfNesting = function() 
  local _dce1 = ___TableWrapper_TableWrapper_Impl_.check(_hx_o({__fields__={doX=true,test=true,objWithArr=true,nest=true,arrWithObjs=true},doX=99,test=true,objWithArr=_hx_o({__fields__={x=true},x=_hx_tab_array({[0]=_hx_o({__fields__={y=true},y="obj -> array -> obj "}), _hx_o({__fields__={y=true},y="second obj -> array -> obj "})}, 2)}),nest=_hx_o({__fields__={a=true},a=_hx_o({__fields__={renest=true,b=true},renest=99,b=_hx_o({__fields__={c=true},c=_hx_o({__fields__={meganest=true},meganest=88})})})}),arrWithObjs=_hx_tab_array({[0]=_hx_o({__fields__={x=true},x="inside array -> obj "}), _hx_o({__fields__={x=true},x="second array -> obj "})}, 2)}));
