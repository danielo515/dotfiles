...
var patches = [
	...
	"nvim_create_user_command.opts" => macro :TableWrapper<{desc:String, force:Bool}>
];
...
function resolveType(fun:String, arg:Null<String>, t:String):ComplexType {
	...
	return switch (t) {
		...
		case t if (StringTools.startsWith(t, "ArrayOf(")):
			var itemType = resolveType(fun, (arg == null ? "" : arg) + "[]", t.split("(")[1].split(",")[0]);
			macro :Array<$itemType>;
...
abstract ParamDef(Array<String>) {
	...
	function get_type():String return this[0];

	public var name(get, never):String;
	function get_name():String return this[1];
}
